        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-gray-50 p-3 rounded-md">
            <p className="text-sm text-gray-600">
              <strong>Preview:</strong> Rows will be labeled as "{options.rowPrefix} {options.startNumber}" to "{options.rowPrefix} {options.endNumber}"
            </p>
            <p className="text-sm text-gray-600 mt-1">
              Seats will be labeled as "{options.seatPrefix}1", "{options.seatPrefix}2", etc.
            </p>
          </div>
